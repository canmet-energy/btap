...
#
#   ruby openstudio-necb/scripts/generate_necb_8_4_coverage.rb          (or: rake necb:coverage_doc)
#
...
#   5. openstudio-necb/scripts/necb_8_4_disposition.json — curated engine/modeller/covered_by/
