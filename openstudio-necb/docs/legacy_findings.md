...
## Added 2026-08-03 (close-out plan Phase 5b filings)

| # | Finding | Status | Evidence |
|---|---------|--------|----------|
| L-29 | The full archetype non-compliance finding (15/17 fail 8.4.1.2 at Toronto/Electricity full-annual; gas 1–11 pts worse) | **FILED** [NatLabRockies/openstudio-standards#2131](https://github.com/NatLabRockies/openstudio-standards/issues/2131), referencing `archetype_compliance_findings.md` | the consolidated 17×2 baseline table; D-58…D-65 |
| — | hbix follow-ups (6.2.2.1 restoration checklist; get_diff rename mapping) | **FILED** [canmet-energy/hbix#95](https://github.com/canmet-energy/hbix/issues/95) | D-61 amendment; D-63 |
| — | `performance_compliance` module "missing upstream" — REFUTED as an upstream issue: origin/develop has NEITHER the module NOR the method; both exist only on phylroy_dnd (phylroy's WIP). Branch-local, not filed | resolved by inspection | [RAN] `git ls-tree origin/develop` (0 hits); L-3/4/5 were ALREADY filed as #2126 (stale memory corrected) |
