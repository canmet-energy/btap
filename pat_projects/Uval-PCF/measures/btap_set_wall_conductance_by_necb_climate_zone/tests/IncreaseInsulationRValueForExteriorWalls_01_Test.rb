...
class BtapIncreaseRValueOfInsulationForExteriorWallsToASpecificValue_Test < Test::Unit::TestCase
  ...
  def test_BtapIncreaseRValueOfInsulationForExteriorWallsToASpecificValue_01_bad
     
    # create an instance of the measure
    measure = BtapIncreaseRValueOfInsulationForExteriorWallsToASpecificValue.new
  ...
  def test_BtapIncreaseRValueOfInsulationForExteriorWallsToASpecificValue_NewConstruction_FullyCosted
  ...
  def test_BtapIncreaseRValueOfInsulationForExteriorWallsToASpecificValue_Retrofit_FullyCosted
  ...
  def test_BtapIncreaseRValueOfInsulationForExteriorWallsToASpecificValue_Retrofit_NoCost
  ...
  def test_BtapIncreaseRValueOfInsulationForExteriorWallsToASpecificValue_ReverseTranslatedModel
  ...
  def test_BtapIncreaseRValueOfInsulationForExteriorWallsToASpecificValue_EmptySpaceNoLoadsOrSurfaces
  ...
  def test_BtapIncreaseRValueOfInsulationForExteriorWallsToASpecificValue__AllowReduction
