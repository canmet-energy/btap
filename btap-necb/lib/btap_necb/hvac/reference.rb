...
module BtapNECB
  ...
  module HVAC
    ...
    # BtapModeling.characterize) and the building info.
    #
    # @param facts [Hash] BtapModeling.characterize output
    ...
    # cleanly via HVAC.apply_efficiencies after sizing).
    #
    ...
    def self.reference_hvac(model, vintage: '2020', building: nil, audit: nil, proposed_annual: nil)
      ...
      assignments.each do |assignment|
        ...
        result = BtapModeling.replace_system(reference, assignment.catalog_name, zones,
