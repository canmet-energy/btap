...
class TestReferenceDaylighting < Minitest::Test
  ...
  def test_reflectances_and_setpoint_inheritance
    ...
    BtapNECB::Lighting.reference_daylighting(reference, vintage: '2020', proposed: proposed,
  ...
  def test_necb_default_placement_flows_through
    ...
    audit = BtapNECB::AuditLog.new
    BtapNECB::Lighting.reference_daylighting(reference, vintage: '2020',
  ...
  def test_photocontrols_reduce_lighting_energy
    ...
    { without: false, with: true }.each do |label, daylighting|
      ...
      BtapNECB::Lighting.reference_daylighting(model, vintage: '2020', placement: :all) if daylighting
