...
#
# Since R3 (D-81) the registry CONTENT is canonical in python/btap/necb/data/
# decisions.json — the copy this file reads is GENERATED by
# python/scripts/sync_decisions_registry.py and byte-identity is CI-enforced.
# Repair direction: edit the canonical Python registry (and the doc), then
# regenerate. These duties stay live until R6: both implementations ship, so
# both must satisfy them.
