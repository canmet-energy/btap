...
# This measure is based upon the measure in the unmet hours repository.
# https://github.com/UnmetHours/openstudio-measures/tree/master/ideal_loads_options
...
class IdealLoadsOptions < OpenStudio::Ruleset::WorkspaceUserScript
  ...
  # human readable name
  def name
    return "BTAPIdealAirLoadsOptionsEplus"
  end
