...
class BtapSetEnvelopeConductanceByNecbClimateZone_Test  < Minitest::Test
 ...
 def test_Zone4_conductane
   ...
   arguments = measure.arguments(model)
    ...
    puts " \e[32m Zone 4 ( Victoria), test r-value of 31.03  >>>>>>>>>>  is equal to : #{arguments[2].defaultValueAsDouble} \e[0m "
    else
    puts " \e[33m Error : Zone 4 ( Victoria), test r-value of 31.03  >>>>>>>>>>  is NOT equal to : #{arguments[2].defaultValueAsDouble} \e[0m "
    end
 end
  ...
  def test_Zone7a_conductane
   ...
   assert_equal(35.05, arguments[5].defaultValueAsDouble)
    puts " \e[32m Zone 7A test r-value of 35.05  >>>>>>>>>>  is equal to : #{arguments[5].defaultValueAsDouble}  \e[0m"
  end
  ...
  assert_equal(39.99, arguments[6].defaultValueAsDouble)
    puts "  \e[32m Zone 7B (White-horse), test r-value of 39.99  >>>>>>>>>>  is equal to : #{arguments[6].defaultValueAsDouble} \e[0m "
  end
  ...
  def test_Zone8_conductane
    ...
    puts " \e[31m Zone 8 (Yellowknife), test r-value of 47.32  >>>>>>>>>>  is equal to : #{arguments[7].defaultValueAsDouble} \e[0m "
  end
