"""The HVAC domain of btap.codes: reference-system selection (8.4.4.7-.19),
...
from btap.codes.necb.hvac import checker, efficiency, energy_recovery, reference
from btap.codes.necb.hvac.checker import check_part5
from btap.codes.necb.hvac.efficiency import apply_efficiencies, prepare_for_resizing
from btap.codes.necb.hvac.energy_recovery import (
