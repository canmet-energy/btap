...
``eui_data`` and ``eui_building_energy_target`` came here from ``tiers.py``
under D-86, unchanged: they read the Table 8.4.4.1 targets this module already
consumed, and they exist only in NECB 2025."""
...
def defaults_for(archetype):
    ...
    it."""
    table = eui_data()["archetype_defaults_table_8_4_4_2"]
