...
#
#   ruby btap-modeling/scripts/simulate_all_systems.rb [--jobs N] [--only substring]
#
...
FIXTURES = File.join(ROOT, 'btap-modeling/test/fixtures')
...
systems = BtapModeling::Catalog.rows.map { |r| [r['name'], r['family']] }
...
out = File.join(ROOT, 'btap-modeling/test/fixtures/system_simulation_status.json')
