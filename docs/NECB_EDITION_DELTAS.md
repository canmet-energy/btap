...
| `curves.0.implements.grid` | changed | the ten printed points, PLR 0.10 to 1.00 step 0.10 → PLR 0 (node value 0), 0.00001 to 0.0001 step 0.00001, 0.0001 to 0.001 step 0.0001, 0.001 to 0.05 step 0.001, 0.05 to 0.10 step 0.005, 0.10 to 1.00 step 0.01 (169 nodes) |
...
| `curves.0.minimum_dependent_variable_output` | changed | 0.847458 → 0.0 |
| `curves.0.minimum_independent_variable_1` | changed | 0.1 → 0.0 |
| `curves.0.name` | changed | BOILER-PLF-MODULATING-necb2020 → BOILER-PLF-MODULATING-necb2025 |
| `curves.0.points.0.0` | changed | 0.1 → 0.0 |
| `curves.0.points.0.1` | changed | 0.847458 → 0.0 |
| `curves.0.points.1.0` | changed | 0.2 → 1e-05 |
| `curves.0.points.1.1` | changed | 0.956938 → 0.000556 |
| `curves.0.points.2.0` | changed | 0.3 → 2e-05 |
| `curves.0.points.2.1` | changed | 0.974026 → 0.001111 |
| `curves.0.points.3.0` | changed | 0.4 → 3e-05 |
| `curves.0.points.3.1` | changed | 0.982801 → 0.001665 |
| `curves.0.points.4.0` | changed | 0.5 → 4e-05 |
| `curves.0.points.4.1` | changed | 0.988142 → 0.002219 |
| `curves.0.points.5.0` | changed | 0.6 → 5e-05 |
| `curves.0.points.5.1` | changed | 0.991736 → 0.002772 |
| `curves.0.points.6.0` | changed | 0.7 → 6e-05 |
| `curves.0.points.6.1` | changed | 0.994318 → 0.003325 |
| `curves.0.points.7.0` | changed | 0.8 → 7e-05 |
| `curves.0.points.7.1` | changed | 0.997506 → 0.003877 |
| `curves.0.points.8.0` | changed | 0.9 → 8e-05 |
| `curves.0.points.8.1` | changed | 0.99889 → 0.004429 |
| `curves.0.points.9.0` | changed | 1.0 → 9e-05 |
| `curves.0.points.9.1` | changed | 1.0 → 0.00498 |
...
| `curves.0.points.10.0` | added | — → 0.0001 |
| `curves.0.points.10.1` | added | — → 0.00553 |
| `curves.0.points.100.0` | added | — → 0.32 |
| `curves.0.points.100.1` | added | — → 0.972216 |
| `curves.0.points.101.0` | added | — → 0.33 |
| `curves.0.points.101.1` | added | — → 0.973682 |
| `curves.0.points.102.0` | added | — → 0.34 |
| `curves.0.points.102.1` | added | — → 0.975057 |
| `curves.0.points.103.0` | added | — → 0.35 |
| `curves.0.points.103.1` | added | — → 0.976349 |
| `curves.0.points.104.0` | added | — → 0.36 |
| `curves.0.points.104.1` | added | — → 0.977564 |
| `curves.0.points.105.0` | added | — → 0.37 |
| `curves.0.points.105.1` | added | — → 0.978708 |
| `curves.0.points.106.0` | added | — → 0.38 |
| `curves.0.points.106.1` | added | — → 0.979787 |
| `curves.0.points.107.0` | added | — → 0.39 |
| `curves.0.points.107.1` | added | — → 0.980805 |
| `curves.0.points.108.0` | added | — → 0.4 |
| `curves.0.points.108.1` | added | — → 0.981766 |
| `curves.0.points.109.0` | added | — → 0.41 |
| `curves.0.points.109.1` | added | — → 0.982675 |
| `curves.0.points.11.0` | added | — → 0.0002 |
| `curves.0.points.11.1` | added | — → 0.011001 |
| `curves.0.points.110.0` | added | — → 0.42 |
| `curves.0.points.110.1` | added | — → 0.983535 |
| `curves.0.points.111.0` | added | — → 0.43 |
| `curves.0.points.111.1` | added | — → 0.98435 |
| `curves.0.points.112.0` | added | — → 0.44 |
| `curves.0.points.112.1` | added | — → 0.985122 |
| `curves.0.points.113.0` | added | — → 0.45 |
| `curves.0.points.113.1` | added | — → 0.985854 |
| `curves.0.points.114.0` | added | — → 0.46 |
| `curves.0.points.114.1` | added | — → 0.986549 |
| `curves.0.points.115.0` | added | — → 0.47 |
| `curves.0.points.115.1` | added | — → 0.987208 |
| `curves.0.points.116.0` | added | — → 0.48 |
| `curves.0.points.116.1` | added | — → 0.987835 |
| `curves.0.points.117.0` | added | — → 0.49 |
| `curves.0.points.117.1` | added | — → 0.988431 |
| `curves.0.points.118.0` | added | — → 0.5 |
| `curves.0.points.118.1` | added | — → 0.988998 |
| `curves.0.points.119.0` | added | — → 0.51 |
| `curves.0.points.119.1` | added | — → 0.989537 |
| `curves.0.points.12.0` | added | — → 0.0003 |
| `curves.0.points.12.1` | added | — → 0.016414 |
| `curves.0.points.120.0` | added | — → 0.52 |
| `curves.0.points.120.1` | added | — → 0.99005 |
| `curves.0.points.121.0` | added | — → 0.53 |
| `curves.0.points.121.1` | added | — → 0.990538 |
| `curves.0.points.122.0` | added | — → 0.54 |
| `curves.0.points.122.1` | added | — → 0.991003 |
| `curves.0.points.123.0` | added | — → 0.55 |
| `curves.0.points.123.1` | added | — → 0.991447 |
| `curves.0.points.124.0` | added | — → 0.56 |
| `curves.0.points.124.1` | added | — → 0.991869 |
| `curves.0.points.125.0` | added | — → 0.57 |
| `curves.0.points.125.1` | added | — → 0.992271 |
| `curves.0.points.126.0` | added | — → 0.58 |
| `curves.0.points.126.1` | added | — → 0.992655 |
| `curves.0.points.127.0` | added | — → 0.59 |
| `curves.0.points.127.1` | added | — → 0.993021 |
| `curves.0.points.128.0` | added | — → 0.6 |
| `curves.0.points.128.1` | added | — → 0.99337 |
| `curves.0.points.129.0` | added | — → 0.61 |
| `curves.0.points.129.1` | added | — → 0.993702 |
| `curves.0.points.13.0` | added | — → 0.0004 |
| `curves.0.points.13.1` | added | — → 0.02177 |
| `curves.0.points.130.0` | added | — → 0.62 |
| `curves.0.points.130.1` | added | — → 0.994019 |
| `curves.0.points.131.0` | added | — → 0.63 |
| `curves.0.points.131.1` | added | — → 0.994322 |
| `curves.0.points.132.0` | added | — → 0.64 |
| `curves.0.points.132.1` | added | — → 0.99461 |
| `curves.0.points.133.0` | added | — → 0.65 |
| `curves.0.points.133.1` | added | — → 0.994885 |
| `curves.0.points.134.0` | added | — → 0.66 |
| `curves.0.points.134.1` | added | — → 0.995147 |
| `curves.0.points.135.0` | added | — → 0.67 |
| `curves.0.points.135.1` | added | — → 0.995397 |
| `curves.0.points.136.0` | added | — → 0.68 |
| `curves.0.points.136.1` | added | — → 0.995635 |
| `curves.0.points.137.0` | added | — → 0.69 |
| `curves.0.points.137.1` | added | — → 0.995862 |
| `curves.0.points.138.0` | added | — → 0.7 |
| `curves.0.points.138.1` | added | — → 0.996078 |
| `curves.0.points.139.0` | added | — → 0.71 |
| `curves.0.points.139.1` | added | — → 0.996284 |
| `curves.0.points.14.0` | added | — → 0.0005 |
| `curves.0.points.14.1` | added | — → 0.02707 |
| `curves.0.points.140.0` | added | — → 0.72 |
| `curves.0.points.140.1` | added | — → 0.996479 |
| `curves.0.points.141.0` | added | — → 0.73 |
| `curves.0.points.141.1` | added | — → 0.996666 |
| `curves.0.points.142.0` | added | — → 0.74 |
| `curves.0.points.142.1` | added | — → 0.996843 |
| `curves.0.points.143.0` | added | — → 0.75 |
| `curves.0.points.143.1` | added | — → 0.997012 |
| `curves.0.points.144.0` | added | — → 0.76 |
| `curves.0.points.144.1` | added | — → 0.997172 |
| `curves.0.points.145.0` | added | — → 0.77 |
| `curves.0.points.145.1` | added | — → 0.997324 |
| `curves.0.points.146.0` | added | — → 0.78 |
| `curves.0.points.146.1` | added | — → 0.997468 |
| `curves.0.points.147.0` | added | — → 0.79 |
| `curves.0.points.147.1` | added | — → 0.997605 |
| `curves.0.points.148.0` | added | — → 0.8 |
| `curves.0.points.148.1` | added | — → 0.997734 |
| `curves.0.points.149.0` | added | — → 0.81 |
| `curves.0.points.149.1` | added | — → 0.997856 |
| `curves.0.points.15.0` | added | — → 0.0006 |
| `curves.0.points.15.1` | added | — → 0.032315 |
| `curves.0.points.150.0` | added | — → 0.82 |
| `curves.0.points.150.1` | added | — → 0.997972 |
| `curves.0.points.151.0` | added | — → 0.83 |
| `curves.0.points.151.1` | added | — → 0.998082 |
| `curves.0.points.152.0` | added | — → 0.84 |
| `curves.0.points.152.1` | added | — → 0.998185 |
| `curves.0.points.153.0` | added | — → 0.85 |
| `curves.0.points.153.1` | added | — → 0.998282 |
| `curves.0.points.154.0` | added | — → 0.86 |
| `curves.0.points.154.1` | added | — → 0.998373 |
| `curves.0.points.155.0` | added | — → 0.87 |
| `curves.0.points.155.1` | added | — → 0.998458 |
| `curves.0.points.156.0` | added | — → 0.88 |
| `curves.0.points.156.1` | added | — → 0.998539 |
| `curves.0.points.157.0` | added | — → 0.89 |
| `curves.0.points.157.1` | added | — → 0.998613 |
| `curves.0.points.158.0` | added | — → 0.9 |
| `curves.0.points.158.1` | added | — → 0.998683 |
| `curves.0.points.159.0` | added | — → 0.91 |
| `curves.0.points.159.1` | added | — → 0.998748 |
| `curves.0.points.16.0` | added | — → 0.0007 |
| `curves.0.points.16.1` | added | — → 0.037506 |
| `curves.0.points.160.0` | added | — → 0.92 |
| `curves.0.points.160.1` | added | — → 0.998808 |
| `curves.0.points.161.0` | added | — → 0.93 |
| `curves.0.points.161.1` | added | — → 0.998864 |
| `curves.0.points.162.0` | added | — → 0.94 |
| `curves.0.points.162.1` | added | — → 0.998915 |
| `curves.0.points.163.0` | added | — → 0.95 |
| `curves.0.points.163.1` | added | — → 0.998962 |
| `curves.0.points.164.0` | added | — → 0.96 |
| `curves.0.points.164.1` | added | — → 0.999004 |
| `curves.0.points.165.0` | added | — → 0.97 |
| `curves.0.points.165.1` | added | — → 0.999043 |
| `curves.0.points.166.0` | added | — → 0.98 |
| `curves.0.points.166.1` | added | — → 0.999077 |
| `curves.0.points.167.0` | added | — → 0.99 |
| `curves.0.points.167.1` | added | — → 0.999108 |
| `curves.0.points.168.0` | added | — → 1.0 |
| `curves.0.points.168.1` | added | — → 0.999135 |
| `curves.0.points.17.0` | added | — → 0.0008 |
| `curves.0.points.17.1` | added | — → 0.042643 |
| `curves.0.points.18.0` | added | — → 0.0009 |
| `curves.0.points.18.1` | added | — → 0.047727 |
| `curves.0.points.19.0` | added | — → 0.001 |
| `curves.0.points.19.1` | added | — → 0.052759 |
| `curves.0.points.20.0` | added | — → 0.002 |
| `curves.0.points.20.1` | added | — → 0.100394 |
| `curves.0.points.21.0` | added | — → 0.003 |
| `curves.0.points.21.1` | added | — → 0.143616 |
| `curves.0.points.22.0` | added | — → 0.004 |
| `curves.0.points.22.1` | added | — → 0.183011 |
| `curves.0.points.23.0` | added | — → 0.005 |
| `curves.0.points.23.1` | added | — → 0.219066 |
| `curves.0.points.24.0` | added | — → 0.006 |
| `curves.0.points.24.1` | added | — → 0.252188 |
| `curves.0.points.25.0` | added | — → 0.007 |
| `curves.0.points.25.1` | added | — → 0.282721 |
| `curves.0.points.26.0` | added | — → 0.008 |
| `curves.0.points.26.1` | added | — → 0.310957 |
| `curves.0.points.27.0` | added | — → 0.009 |
| `curves.0.points.27.1` | added | — → 0.337145 |
| `curves.0.points.28.0` | added | — → 0.01 |
| `curves.0.points.28.1` | added | — → 0.361501 |
| `curves.0.points.29.0` | added | — → 0.011 |
| `curves.0.points.29.1` | added | — → 0.38421 |
| `curves.0.points.30.0` | added | — → 0.012 |
| `curves.0.points.30.1` | added | — → 0.405433 |
| `curves.0.points.31.0` | added | — → 0.013 |
| `curves.0.points.31.1` | added | — → 0.425312 |
| `curves.0.points.32.0` | added | — → 0.014 |
| `curves.0.points.32.1` | added | — → 0.44397 |
| `curves.0.points.33.0` | added | — → 0.015 |
| `curves.0.points.33.1` | added | — → 0.461517 |
| `curves.0.points.34.0` | added | — → 0.016 |
| `curves.0.points.34.1` | added | — → 0.478048 |
| `curves.0.points.35.0` | added | — → 0.017 |
| `curves.0.points.35.1` | added | — → 0.49365 |
| `curves.0.points.36.0` | added | — → 0.018 |
| `curves.0.points.36.1` | added | — → 0.508398 |
| `curves.0.points.37.0` | added | — → 0.019 |
| `curves.0.points.37.1` | added | — → 0.522361 |
| `curves.0.points.38.0` | added | — → 0.02 |
| `curves.0.points.38.1` | added | — → 0.535599 |
| `curves.0.points.39.0` | added | — → 0.021 |
| `curves.0.points.39.1` | added | — → 0.548168 |
| `curves.0.points.40.0` | added | — → 0.022 |
| `curves.0.points.40.1` | added | — → 0.560117 |
| `curves.0.points.41.0` | added | — → 0.023 |
| `curves.0.points.41.1` | added | — → 0.571491 |
| `curves.0.points.42.0` | added | — → 0.024 |
| `curves.0.points.42.1` | added | — → 0.58233 |
| `curves.0.points.43.0` | added | — → 0.025 |
| `curves.0.points.43.1` | added | — → 0.592671 |
| `curves.0.points.44.0` | added | — → 0.026 |
| `curves.0.points.44.1` | added | — → 0.602547 |
| `curves.0.points.45.0` | added | — → 0.027 |
| `curves.0.points.45.1` | added | — → 0.61199 |
| `curves.0.points.46.0` | added | — → 0.028 |
| `curves.0.points.46.1` | added | — → 0.621026 |
| `curves.0.points.47.0` | added | — → 0.029 |
| `curves.0.points.47.1` | added | — → 0.629682 |
| `curves.0.points.48.0` | added | — → 0.03 |
| `curves.0.points.48.1` | added | — → 0.637982 |
| `curves.0.points.49.0` | added | — → 0.031 |
| `curves.0.points.49.1` | added | — → 0.645945 |
| `curves.0.points.50.0` | added | — → 0.032 |
| `curves.0.points.50.1` | added | — → 0.653594 |
| `curves.0.points.51.0` | added | — → 0.033 |
| `curves.0.points.51.1` | added | — → 0.660945 |
| `curves.0.points.52.0` | added | — → 0.034 |
| `curves.0.points.52.1` | added | — → 0.668016 |
| `curves.0.points.53.0` | added | — → 0.035 |
| `curves.0.points.53.1` | added | — → 0.674823 |
| `curves.0.points.54.0` | added | — → 0.036 |
| `curves.0.points.54.1` | added | — → 0.68138 |
| `curves.0.points.55.0` | added | — → 0.037 |
| `curves.0.points.55.1` | added | — → 0.6877 |
| `curves.0.points.56.0` | added | — → 0.038 |
| `curves.0.points.56.1` | added | — → 0.693796 |
| `curves.0.points.57.0` | added | — → 0.039 |
| `curves.0.points.57.1` | added | — → 0.699681 |
| `curves.0.points.58.0` | added | — → 0.04 |
| `curves.0.points.58.1` | added | — → 0.705363 |
| `curves.0.points.59.0` | added | — → 0.041 |
| `curves.0.points.59.1` | added | — → 0.710855 |
| `curves.0.points.60.0` | added | — → 0.042 |
| `curves.0.points.60.1` | added | — → 0.716164 |
| `curves.0.points.61.0` | added | — → 0.043 |
| `curves.0.points.61.1` | added | — → 0.721301 |
| `curves.0.points.62.0` | added | — → 0.044 |
| `curves.0.points.62.1` | added | — → 0.726273 |
| `curves.0.points.63.0` | added | — → 0.045 |
| `curves.0.points.63.1` | added | — → 0.731089 |
| `curves.0.points.64.0` | added | — → 0.046 |
| `curves.0.points.64.1` | added | — → 0.735754 |
| `curves.0.points.65.0` | added | — → 0.047 |
| `curves.0.points.65.1` | added | — → 0.740277 |
| `curves.0.points.66.0` | added | — → 0.048 |
| `curves.0.points.66.1` | added | — → 0.744664 |
| `curves.0.points.67.0` | added | — → 0.049 |
| `curves.0.points.67.1` | added | — → 0.74892 |
| `curves.0.points.68.0` | added | — → 0.05 |
| `curves.0.points.68.1` | added | — → 0.753052 |
| `curves.0.points.69.0` | added | — → 0.055 |
| `curves.0.points.69.1` | added | — → 0.772019 |
| `curves.0.points.70.0` | added | — → 0.06 |
| `curves.0.points.70.1` | added | — → 0.788563 |
| `curves.0.points.71.0` | added | — → 0.065 |
| `curves.0.points.71.1` | added | — → 0.803118 |
| `curves.0.points.72.0` | added | — → 0.07 |
| `curves.0.points.72.1` | added | — → 0.816021 |
| `curves.0.points.73.0` | added | — → 0.075 |
| `curves.0.points.73.1` | added | — → 0.827537 |
| `curves.0.points.74.0` | added | — → 0.08 |
| `curves.0.points.74.1` | added | — → 0.837876 |
| `curves.0.points.75.0` | added | — → 0.085 |
| `curves.0.points.75.1` | added | — → 0.847209 |
| `curves.0.points.76.0` | added | — → 0.09 |
| `curves.0.points.76.1` | added | — → 0.855676 |
| `curves.0.points.77.0` | added | — → 0.095 |
| `curves.0.points.77.1` | added | — → 0.86339 |
| `curves.0.points.78.0` | added | — → 0.1 |
| `curves.0.points.78.1` | added | — → 0.870446 |
| `curves.0.points.79.0` | added | — → 0.11 |
| `curves.0.points.79.1` | added | — → 0.882894 |
| `curves.0.points.80.0` | added | — → 0.12 |
| `curves.0.points.80.1` | added | — → 0.893521 |
| `curves.0.points.81.0` | added | — → 0.13 |
| `curves.0.points.81.1` | added | — → 0.902696 |
| `curves.0.points.82.0` | added | — → 0.14 |
| `curves.0.points.82.1` | added | — → 0.910694 |
| `curves.0.points.83.0` | added | — → 0.15 |
| `curves.0.points.83.1` | added | — → 0.917723 |
| `curves.0.points.84.0` | added | — → 0.16 |
| `curves.0.points.84.1` | added | — → 0.923947 |
| `curves.0.points.85.0` | added | — → 0.17 |
| `curves.0.points.85.1` | added | — → 0.929493 |
| `curves.0.points.86.0` | added | — → 0.18 |
| `curves.0.points.86.1` | added | — → 0.934464 |
| `curves.0.points.87.0` | added | — → 0.19 |
| `curves.0.points.87.1` | added | — → 0.938943 |
| `curves.0.points.88.0` | added | — → 0.2 |
| `curves.0.points.88.1` | added | — → 0.942997 |
| `curves.0.points.89.0` | added | — → 0.21 |
| `curves.0.points.89.1` | added | — → 0.946682 |
| `curves.0.points.90.0` | added | — → 0.22 |
| `curves.0.points.90.1` | added | — → 0.950045 |
| `curves.0.points.91.0` | added | — → 0.23 |
| `curves.0.points.91.1` | added | — → 0.953124 |
| `curves.0.points.92.0` | added | — → 0.24 |
| `curves.0.points.92.1` | added | — → 0.955952 |
| `curves.0.points.93.0` | added | — → 0.25 |
| `curves.0.points.93.1` | added | — → 0.958557 |
| `curves.0.points.94.0` | added | — → 0.26 |
| `curves.0.points.94.1` | added | — → 0.960964 |
| `curves.0.points.95.0` | added | — → 0.27 |
| `curves.0.points.95.1` | added | — → 0.963192 |
| `curves.0.points.96.0` | added | — → 0.28 |
| `curves.0.points.96.1` | added | — → 0.965261 |
| `curves.0.points.97.0` | added | — → 0.29 |
| `curves.0.points.97.1` | added | — → 0.967184 |
| `curves.0.points.98.0` | added | — → 0.3 |
| `curves.0.points.98.1` | added | — → 0.968977 |
| `curves.0.points.99.0` | added | — → 0.31 |
| `curves.0.points.99.1` | added | — → 0.970651 |
