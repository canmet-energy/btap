...
class TestStorageGarage < Minitest::Test
  SG = OpenStudioLighting::NECB::StorageGarage
  PERIM = OpenStudioLighting::NECB::StorageGarage::Perimeter
  ...
  def audit = OpenStudioLighting::AuditLog.new
  ...
  def test_the_general_occupancy_path_no_longer_claims_this_article
    source = File.read(File.expand_path('../lib/openstudio_lighting/necb/apply_lights.rb', __dir__),
                       encoding: 'UTF-8')
