...
class TestCostingForeign < Minitest::Test
  ...
  def test_cost_without_systems_matches_cost_with_systems
    ...
    with = BtapCosting::HVAC.cost(model, systems: [result], city: 'TORONTO', province_state: 'ONTARIO')
    without = BtapCosting::HVAC.cost(model, city: 'TORONTO', province_state: 'ONTARIO')
  ...
  def test_foreign_osm_costed_via_structural_classification
    ...
    foreign = BtapCosting::HVAC.cost(model, city: 'TORONTO', province_state: 'ONTARIO')
  ...
  def test_legacy_pipe_named_osm_costed
    ...
    legacy = BtapCosting::HVAC.cost(model, city: 'TORONTO', province_state: 'ONTARIO')
  ...
  def test_unified_audit_across_reference_and_costing
    ...
    report = BtapCosting::HVAC.cost(ref, city: 'TORONTO', province_state: 'ONTARIO', audit: audit)
